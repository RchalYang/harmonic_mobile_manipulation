...
class OpeningDoorBaseConfig(ExperimentConfig, ABC):
    ...
    def train_task_sampler_args(self, **kwargs) -> Dict[str, Any]:
        ...
        train_houses = filter_dataset(train_houses, close_door=False, init_openness=cfg.task_config["init_openness"])
    ...
    def valid_task_sampler_args(self, **kwargs) -> Dict[str, Any]:
        ...
        val_houses = filter_dataset(val_houses, close_door=False, init_openness=cfg.task_config["init_openness"])
        out = self._get_sampler_args_for_scene_split(
            houses=val_houses,
            mode="eval",
    ...
    def test_task_sampler_args(self, **kwargs) -> Dict[str, Any]:
        ...
        test_houses = filter_dataset(test_houses, close_door=False, init_openness=cfg.task_config["init_openness"])
