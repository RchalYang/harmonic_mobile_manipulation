...
from ..models.ncamera_dino import (
    ...
    VitMultiModalDenseNCameraActorCritic,
    VitMultiModalHistNCameraActorCritic,
    VitMultiModalHistDenseNCameraActorCritic,
...
class OpeningDoorGraspTwoStageFullMultiModalDinoViTPPOExperimentConfig(OpeningDoorBaseConfig):
  ...
  @classmethod
  def tag(cls):
    return "OpeningDoor-NavCamV2-Augmented-DinoViTGRU-DDPPO"
    ...
    if rgb_sensor_navigation is not None:
      preprocessors.append(
          get_dino_preprocessor(self.DINO_PREPROCESSOR_TYPE, cfg,
                                rgb_sensor_navigation, "rgb_navigation_dino_vit")
      )
