...
class OpeningDoorGraspManipCamDinoViTPPOExperimentConfig(OpeningDoorBaseConfig):
  ...
  @classmethod
  def tag(cls):
    return "OpeningDoor-ManipCamV2-Augmented-DinoViTGRU-DDPPO"
  ...
  def preprocessors(self) -> Sequence[Union[Preprocessor, Builder[Preprocessor]]]:
    ...
    if rgb_sensor_manipulation is not None:
      preprocessors.append(
          get_dino_preprocessor(self.DINO_PREPROCESSOR_TYPE, cfg,
                                rgb_sensor_manipulation, "rgb_manipulation_dino_vit")
      )
